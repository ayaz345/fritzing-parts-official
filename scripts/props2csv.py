...
def main():
    ...
    try:
        ...
        writer.writerow(["fzp", "location", "title", "description",
                         "family", "props", "tags", "taxonomy"])
    except:
    ...
    for filename in os.listdir(outputDir):
        if (filename.endswith(".fzp")):
            ...
            writer.writerow([filename, location, titleText.encode("utf-8"), descriptionText.encode("utf-8"), familyText.encode(
                "utf-8"), propertiesText.encode("utf-8"), tagsText.encode("utf-8"), taxonomyText.encode("utf-8")])
